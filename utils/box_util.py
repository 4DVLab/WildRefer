...
def resize_img_keep_ratio(img, target_size):
    ...
    return img_new, ratio, pad_w, pad_h

def resize_box_keep_ratio(box, ratio, pad_w, pad_h):
    box[0] = box[0] * ratio + pad_w // 2
    box[1] = box[1] * ratio + pad_h // 2
    box[2] = box[2] * ratio + pad_w // 2
    box[3] = box[3] * ratio + pad_h // 2
    return box

def resize_box_to_original_size(box, ratio, pad_w, pad_h):
    box[0] = (box[0] - pad_w // 2) // ratio
    box[1] = (box[1] - pad_h // 2) // ratio
    box[2] = (box[2] - pad_w // 2) // ratio
    box[3] = (box[3] - pad_h // 2) // ratio
    return box
